...
/**
 * Retained upstream skill-restoration timer with its per-entity registration
 * debug message removed. Fake players legitimately receive this auto timer too,
 * so routing Player.debug() to the single-player console made normal startup
 * look like the same human timer was being registered dozens of times.
 */
