...
public class ClientProt {
	...
	public static void method3502(@OriginalArg(1) int arg0, @OriginalArg(2) int arg1) {
		// Ordinary world clicks can go straight to 2009Scape's existing typed
		// WorldspaceWalk command. This removes serialization, localhost TCP and
		// decoding for the first real gameplay command while retaining the old path
		// as a safe fallback. Minimap/interact walks remain legacy for now because
		// their callers append additional protocol data after this method returns.
