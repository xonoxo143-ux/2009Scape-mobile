 ...
 *
 * Operations move to the in-process typed command bridge one family at a time.
 * The original wire path remains as a fallback until parity is proven, then it
 * can be deleted with the socket/protocol layer.
 */
