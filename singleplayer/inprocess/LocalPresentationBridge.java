 ...
 * existing 2009Scape encoders and RT4 decoders can keep speaking their exact
...
public final class LocalPresentationBridge {
    ...
    /** Called by RT4 after the normal login/bootstrap stream has settled. */
     ...
     * queue is empty, so no older bytes can be stranded behind newer local data.
     */
    ...
    /** Test/restart hook. Never used as an ordinary gameplay operation. */
