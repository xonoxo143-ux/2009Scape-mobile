...
class GlassCraftingPulse(
    ...
    override fun pulse(): Boolean {
        ...
        if (removeItem(player, Items.MOLTEN_GLASS_1775)) {
            ...
            player.dispatch(ResourceProducedEvent(product.producedItemId, product.amount, player, Items.MOLTEN_GLASS_1775, ResourceActivity.PRODUCTION, ResourceSkill.CRAFTING))

        } else return true

        amount--
        delay = GrandLeagueManager.productionDelay(player, 3)
