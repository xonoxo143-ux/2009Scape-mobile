...
/** Starts the embedded world and opens the client only after its loopback socket is live. */
        ...
        Thread probe = new Thread(() -> {
            ...
            activity.runOnUiThread(() -> {
                ...
                if (serverReady) {
                    ...
                    Toast.makeText(activity, "Local Grand League world did not start. Check the server notification/log.", Toast.LENGTH_LONG).show();
                }
            });
